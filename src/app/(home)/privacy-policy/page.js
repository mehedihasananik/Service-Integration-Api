...
export const metadata = {
  title: "Envobyte Ltd || Privacy Policy",
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              ...
              subscription process, through any contact with us (e.g. telephone
              call or email), or when you buy or use our services and products
              or from third parties where you have authorised this or the
              information is publicly available. If possible, we will collect
              personal information and country location from you directly.
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            only that information that pertains to the service being provided by
            the third party.
          </p>
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              information, may be collected. We do not receive or retain copies
              of this information on our server. We redirect visitors to a
              secure server to complete these transactions and all data is both
              collected and stored by these processors. Current payment gateways
              in user are maintained by 2Checkout.
            </li>
          ...
          <p>
            ...
            readily retrievable personal information that we hold and to request
            a correction to your personal information. Before you exercise this
            right, we will need evidence to confirm that you are the individual
            to whom the personal information relates. In respect of a request
            for correction, if we think the correction is reasonable and we are
            reasonably able to change the personal information, we will make the
          ...
          <p>
            An internet “cookie” is a small piece of code which is placed on the
            your local computer when you visit our website. This helps us learn
            which areas of the website are useful to you and most used by our
            visitors.
          </p>
          <p>
