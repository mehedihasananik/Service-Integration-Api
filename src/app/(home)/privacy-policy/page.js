    ...
    <Container>
      <div className="bg-gray-100 mt-5 px-10">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Welcome to Envobyte Ltd. This Privacy Policy outlines our practices
            regarding the collection, use, and sharing of personal information
            through our digital products and services, including Envobyte. By
            using our services, provided by Envobyte Ltd, you agree to the
          ...
          <p className="mb-4">
            ...
            computer&apo;s hard drive. Once you agree, the file is added, and
