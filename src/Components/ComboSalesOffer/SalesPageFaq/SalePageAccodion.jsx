...
const SalePageAccodion = ({ title, answer, index, isOpen, onClick }) => {
  return (
    <div className="py-2 rounded-md">
      <button
        onClick={onClick}
        className="flex justify-between items-center w-full py-3 px-3 md:px-4 font-semibold border-b "
      >
        <div className="flex items-center gap-2 md:gap-4">
          <span className={`p-1 md:p-2 rounded-full text-[#0A2C8C]`}>
            0{index + 1}
          </span>
...
export default SalePageAccodion;
