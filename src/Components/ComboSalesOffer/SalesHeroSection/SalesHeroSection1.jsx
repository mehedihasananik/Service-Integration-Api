...
const SalesHeroSection1 = () => {
  ...
  return (
    <div className="">
      <div className="sales_hero2"></div>
      <div className="sales_hero3"></div>
      <div className="sales_hero4"></div>
      {/* Remove conditional classes and add animate by default */}
      <div className="sales_doll animate"></div>
      <div className="sales_doll2 animate"></div>
      <div className="sales_moon animate"></div>
      <div className="sales_title animate"></div>
      <div className="hidden xl:block">
        <div className="max-w-[1520px] mx-auto px-[6%] md:px-[4%] xl:px-[8%] 4xl:px-[4%]">
          <div className="flex md:mt-[15%] lg:mt-[0%] flex-col xl:flex-row justify-between text-white items-center h-auto md:h-[60vh] space-y-0 md:space-y-0 pl-[35px]">
            {/* left side */}
            <div className="w-[60%] text-center md:text-left space-y-0 md:space-y-6 px-4 md:px-0 pt-[9%] ">
              <div className=" ">
                ...
                <div className=" capitalize flex gap-x-8  text-[114px] font-bold leading-[130px] relative -left-[5px]">
                  <span className="font-Oswald ">COMBO</span>{" "}
                  <span className="font-Oswald ">OFFER</span>
                </div>
              </div>
              <div
                style={{ padding: "0", margin: "0", marginTop: "9px" }}
                className="p-0 mt-3"
              >
                <p
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-x-10 justify-center md:justify-start pt-[12px]">
        ...
        <div
          style={{ zIndex: "11" }}
          className="absolute bottom-[8%] left-0 right-0 z-100"
        >
          <SalesStats />
        </div>
      </div>
...
export default SalesHeroSection1;
