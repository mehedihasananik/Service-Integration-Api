...
import {
  ...
  SeePricingButton,
} from "@/Components/ComboPageSections/ComboGroupBtn/ComboGroupBtn";
import { useEffect, useState } from "react";
import { TiArrowRight } from "react-icons/ti";

import { Link } from "react-scroll";

export function SalesBusinessTransform() {
  ...
  return (
    <div className="max-w-[1505px] mx-auto px-[4%] md:px-[0%] xl:px-[4%] 4xl:px-[4%] ">
      <div className="pb-[1%]">
        <div>
          <div className="hidden lg:block px-2 xl:px-0">
            <div className="businessTransformBg">
              <div className="w-[100%] flex justify-evenly ">
                ...
                <div className="md:w-[55%] text-white pt-[5%] flex justify-end">
                  <div>
