      ...
      >
        ...
        <div className="py-4 mt-4 md:mt-0 md:pb-8 flex justify-center px-4 md:px-4">
          <Link
            ...
            className="text-[16px] font-medium text-center text-[#FF693B] border border-[#FF693B] px-6 py-2 w-full rounded-md hover:text-white hover:bg-[#FF693B] transition-all duration-300"
          >
            Contact Now
          </Link>
        </div>
