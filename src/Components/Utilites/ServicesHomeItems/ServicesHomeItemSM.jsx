      ...
      <div className="block md:hidden max-w-[1680px] mx-auto px-[4%] md:px[8%] 4xl:px-[0] 4xl:max-w-[1920px] 3xl:pl-[14%] 4xl:pl-[14%] 6xl:pl-[12%]">
        ...
        <div className="py-6 xl:pt-10 ">
          <div className="flex flex-col lg:flex-row items-center justify-between lg:gap-20 xl:gap-12 lg:py-8">
            ...
            <div className="w-full lg:w-[30%] pb-[8%] md:pb-0">
            ...
            <div>
              ...
              <div className="py-8 lg:py-5 text-center lg:text-left  lg:mt-8">
                <Link
                  href={"/services"}
                  className="bg-[#FF693B] text-white text-[16px]  px-14 py-2.5 font-bold  rounded-lg border border-[#FF693B]  hover:bg-white hover:text-[#FF693B] transition-all duration-300"
                >
                  View all
                </Link>
              </div>
